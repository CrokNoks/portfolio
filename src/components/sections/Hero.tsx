    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center h-full">
        ...
        >
          ...
          >
            Spécialisé en React, NodeJS et TypeScript. Je <b>transforme</b> vos idées en expériences web modernes et performantes conformément aux <b>attentes des utilisateurs</b>.
          </motion.p>
